...
function SeatReservationForm() {
  ...
  let reservationInfo;
  if (reservation)
    reservationInfo = `#${reservation.reservation_id} - ${reservation.first_name} ${reservation.last_name} on ${reservation.reservation_date} at ${reservation.reservation_time} for ${reservation.people}`;
